...
CREATE TABLE analytics.cars (    
    ...
    "year" INTEGER,  -- quoted because year is an SQL control word
    cylinders INTEGER,
    transmission TEXT,
    drive_type TEXT,
    city_mpg INTEGER,
...
```sql
INSERT INTO cars(id,manufacturer,model,displacement,year,cylinders,transmission,drive_type,city_mpg,hwy_mpg,fl,vehicle_class) VALUES

...
-- remember to preface each table name with the staging schema, e.g., "staging.table_name"

TRUNCATE TABLE staging.<your_table>;

\copy staging.<your_table>  FROM '../../data/<your CSV file>' WITH HEADER CSV;
